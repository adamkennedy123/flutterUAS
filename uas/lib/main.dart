  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: Colors.blue[900], // untuk Warna navbar 
        elevation: 20, // Menambahkan bayangan pada navbar
      ),
      body: Container(
        decoration: BoxDecoration(
          image: DecorationImage(
            image: AssetImage('img/background.png'), // Ganti dengan path gambar Anda
            fit: BoxFit.cover,
          ),
        ),
        child: Center(
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              SizedBox(height: 6.0), // Jarak antara doa dan ayat
                              Text(
                              ...
                              SizedBox(height: 3.0), // Jarak antara ayat dan latin
                              Text(
                              ...
                              SizedBox(height: 3.0), // Jarak antara latin dan artinya
                              Text(
